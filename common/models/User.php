...
class User extends ActiveRecord implements IdentityInterface
{
    ...
    public function getUnreadMessageCount(){
        return Yii::$app->db->createCommand('SELECT COUNT(*) FROM message WHERE message_condition_id=2 AND received_user_id='.Yii::$app->user->identity->id)->queryScalar();
    }
    ...
    */
    ...
    public function hasPhotos($user_id){
        return Yii::$app->db->createCommand('SELECT COUNT(id) FROM photo WHERE user_id='.$user_id)->queryScalar(); 
    }
