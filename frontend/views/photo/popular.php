...
<section class="information">
    <section class="local_nav">
        <ul id="local_nav">
            ...
            <li <?php if(Yii::$app->user->identity->id==$_GET['id']) {?>class="active"<?php } ?>>
                <a href="#">
    ...
    <section id="photoblock"  class="inform">
        <ul class="photoblock_nav">
            <li><?=Html::a('ПОСЛЕДНИЕ', ['photo/index', 'id' => Yii::$app->user->identity->id]);?></li>
            <li class="photoblock_nav_active">
                <a href="#">ПОПУЛЯРНЫЕ</a>
            </li>
        </ul>
