...
<section class="information">
    <section class="local_nav">
        <ul id="local_nav">
            ...
            <li>
                <?=Html::a('<img src="image/icons/cv.png">резюме', ['photograph-resume/view', 'profile_id' => Yii::$app->user->identity->getProfileId()]);?>
            </li>
            <li>
    ...
    <section id="friends"  class="inform">
        <ul class="friend_nav">
            ...
            <li class="friend_nav_active"><a href="#">ИСХОДЯЩИЕ ЗАЯВКИ</a></li>
        </ul>
    ...
    Pjax::begin(); ?>
        ...
        'emptyText' => '<p>Исходящих заявок нет</p>',
        ]);?>
    <?php Pjax::end(); ?>
    </section>
</section>
